...
{
	$projectSvc->CreateProject((object)$request);
	/* Redirect to a different page in the current directory that was requested */
	$host  = $_SERVER['HTTP_HOST'];
	$uri   = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
	$extra = 'projectedit.php';
	header("Location: http://$host$uri/$extra");
	exit;
}
$activePortfolios = $portfolioSvc->GetAllActivePortfolios();
$activeProducts = $productSvc->GetAllActiveProducts();
?>
...
<form name="addProject" id="addProject" action="projectadd.php" method="post">
...
<div class="editBox">
	<div class="normal_form">
		...
		<div>
            ...
            <input type="text" name="project_name" id="project_name" style="width:300px;" maxlength="100" value="">
        </div>
		<div>
            <label for="product_manager">Product Manager:</label>
            <input type="text" name="product_manager" id="product_manager" style="width:300px;" maxlength="100" value="">
        </div>
		<div>
            <label for="project_manager">Project Manager:</label>
            <input type="text" name="project_manager" id="project_manager" style="width:300px;" maxlength="100" value="">
        </div>
		<div>
            <label for="dev_team">Dev Team:</label>
            <input type="text" name="dev_team" id="dev_team" style="width:300px;" maxlength="100" value="">
        </div>
		<div>
            <label for="dev_team_size">Team Size:</label>
            # Devs: <input type="text" name="dev_team_size" id="dev_team_size" style="width:25px;" maxlength="3" value="">&nbsp;&nbsp;# QA: <input type="text" name="qa_team_size" id="qa_team_size" style="width:25px;" maxlength="3" value="">
        </div>
		<div>
            <label for="iteration0_start_date">Iteration Zero Start Date:</label>
           <input type="text" name="iteration0_start_date" id="iteration0_start_date" style="width:150px;" maxlength="40" value=""> MM/DD/YYYY
        </div>
		<div>
            <label for="iteration1_start_date">Iteration One Start Date:</label>
           <input type="text" name="iteration1_start_date" id="iteration1_start_date" style="width:150px;" maxlength="40" value=""> MM/DD/YYYY
        </div>
		<div>
            <label for="target_release_date">Target Release Date:</label>
           <input type="text" name="target_release_date" id="target_release_date" style="width:300px;" maxlength="40" value="">
        </div>
		<div>
            <label for="committed_release_date">Commit Release Date:</label>
           <input type="text" name="committed_release_date" id="committed_release_date" style="width:300px;" maxlength="40" value="">
        </div>
		<div>
            <label for="iteration_release_date_committed">Committed in Iteration #:</label>
           <input type="text" name="iteration_release_date_committed" id="iteration_release_date_committed" style="width:25px;" maxlength="3" value="">
        </div>
	</div>
</div>
<div class="editBox">
